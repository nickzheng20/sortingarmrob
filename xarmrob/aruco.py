...
cam_matrix = pickle.load(open("/home/pi/ros2_ws/src/xarmrob/xarmrob/cam_matrix.p","rb"),encoding='bytes')
dist_matrix = pickle.load(open("/home/pi/ros2_ws/src/xarmrob/xarmrob/dist_matrix.p","rb"),encoding='bytes')
